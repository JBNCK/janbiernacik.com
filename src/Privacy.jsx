    ...
    const privacyPolicy = navigator.language === "de-DE" ? (
        <>
            ...
            <div className="main-section">
                ...
                <a className="bold link" href="https://www.dataprivacyframework.gov/" target="_blank"> https://www.dataprivacyframework.gov/</a> (in Englisch) entnehmen. Wir informieren Sie im Rahmen der Datenschutzhinweise, welche von uns eingesetzten Diensteanbieter unter dem Data Privacy Framework zertifiziert sind.
                </p>
            </div>
            ...
            <div className="main-section">
                ...
                <li>
                    ...
                    <span><span className="bold"> Rechtsgrundlagen:</span> Berechtigte Interessen (Art. 6 Abs. 1 S. 1 lit. f) DSGVO);</span>
                    <span className="bold"> Website:</span> <a className="bold link" href="https://www.hetzner.com" target="_blank">https://www.hetzner.com</a>;
                    <span className="bold"> Datenschutzerklärung:</span> <a className="bold link" href="https://www.hetzner.com/de/rechtliches/datenschutz" target="_blank">https://www.hetzner.com/de/rechtliches/datenschutz</a>.
                    <span className="bold"> Auftragsverarbeitungsvertrag:</span> <a className="bold link" href="https://docs.hetzner.com/de/general/general-terms-and-conditions/data-privacy-faq/" target="_blank">https://docs.hetzner.com/de/general/general-terms-and-conditions/data-privacy-faq/</a>.
                </li>
                </ul>
            </div>
            ...
            <div className="main-section">
                ...
                <li>
                    ...
                    <span> Website: </span> <a className="bold link" href="https://fonts.google.com/" target="_blank">https://fonts.google.com/</a>;
                    <span> Datenschutzerklärung: </span> <a className="bold link" href="https://policies.google.com/privacy" target="_blank">https://policies.google.com/privacy</a>;
                    <span> Grundlage Drittlandtransfers: </span> Data Privacy Framework (DPF).
                    <span> Weitere Informationen: </span> <a className="bold link" href="https://developers.google.com/fonts/faq/privacy?hl=de" target="_blank">https://developers.google.com/fonts/faq/privacy?hl=de</a>.
                </li>
                </ul>
            </div>
            ...
            <>
                ...
                <div className="main-section">
                    ...
                    <a className="bold link" href="https://www.dataprivacyframework.gov/" target="_blank">https://www.dataprivacyframework.gov/</a> (in English). We will inform you within the privacy notices which service providers we use that are certified under the Data Privacy Framework.
                    </p>
                </div>
                ...
                <div className="main-section">
                    ...
                    <li>
                        ...
                        <span><span className="bold">Legal bases:</span> Legitimate interests (Art. 6(1)(f) GDPR);</span>
                        <span className="bold">Website:</span> <a className="bold link" href="https://www.hetzner.com" target="_blank">https://www.hetzner.com</a>;
                        <span className="bold">Privacy policy:</span> <a className="bold link" href="https://www.hetzner.com/de/rechtliches/datenschutz" target="_blank">https://www.hetzner.com/de/rechtliches/datenschutz</a>.
                        <span className="bold">Data processing agreement:</span> <a className="bold link" href="https://docs.hetzner.com/de/general/general-terms-and-conditions/data-privacy-faq/" target="_blank">https://docs.hetzner.com/de/general/general-terms-and-conditions/data-privacy-faq/</a>.
                    </li>
                    </ul>
                </div>
                ...
                <div className="main-section">
                    ...
                    <li>
                        ...
                        <span>Website:</span> <a className="bold link" href="https://fonts.google.com/" target="_blank">https://fonts.google.com/</a>;
                        <span>Privacy policy:</span> <a className="bold link" href="https://policies.google.com/privacy" target="_blank">https://policies.google.com/privacy</a>;
                        <span>Basis for third-country transfers:</span> Data Privacy Framework (DPF).
                        <span>Further information:</span> <a className="bold link" href="https://developers.google.com/fonts/faq/privacy?hl=de" target="_blank">https://developers.google.com/fonts/faq/privacy?hl=de</a>.
                    </li>
                    </ul>
                </div>
